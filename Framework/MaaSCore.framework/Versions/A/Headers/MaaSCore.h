...
/**
 Set the console logging level for the specified MaaS module. By default the logging level for all modules is `MaaSLogLevel_None`. For example setting the logging level for MaaSCore to debug you would do: `[MaaSCore setLogLevel:MaaSLogLevel_Debug for Service:[MaaSCore serviceName]]`
